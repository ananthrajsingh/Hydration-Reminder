...
public class ReminderUtilities {
    ...
    public static void sheduleChargingReminder(Context context) {
        ...
        .setConstraint(Constraint.DEVICE_CHARGING)
        // - has the lifetime of the job as forever
        .setLifetime(Lifetime.FOREVER)
        // - has the job recuoccurs every 15 minutes with a window of 15 minutes. You can do this using a
