...
public class NotificationUtils {
    ...
    public final static int WATER_REMINDER_PENDING_INTENT_ID = 1234;
    public final static int WATER_REMINDER_NOTIFICATION_ID = 4321;
    ...
    public static PendingIntent contentIntent(Context context) {
        ...
        return PendingIntent.getActivities(context, WATER_REMINDER_PENDING_INTENT_ID, new Intent[]{startActivityIntent}, PendingIntent.FLAG_UPDATE_CURRENT);
    }
